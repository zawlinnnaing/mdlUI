...
@section('content')
		...
		<div class="tile is-ancestor is-parent">
			<div class="tile is-6 content is-vertical" style="border: 1px solid #dddddd; margin: 5px;
			 padding: 15px;">
				<h4 class="title is-4">Undergraduate Programmes</h4>
				...
				<h5 class="title is-5">List of Bachelor Degree Programmes</h5>
				<ul>
				...
				<p>The pathway to B.E. degree is divided into four blocks. The students must have passed all the subjects in each block before proceeding to the next block. Programmes at undergraduate level emphasize both theoretical and practical aspects of engineering. Students are required to attend lectures to enhance their knowledge and also do practical laboratory work to better understand the theory. The programme is conducted full time. The B.E. degree programme takes six years. In the final year, the students are required to submit a mini-thesis at the end of the first semester as partial fulfillment of the requirements of the Bachelor of Engineering degree. Besides, they will be attached to respective industries for the whole second semester as interns. At the end of the internship programme, they must submit report to the Board of Examiners for evaluation. They will get the degree only if all the requirements are fulfilled.</p>
			</div>
			<div class="tile is-6 content is-vertical" style="border: 1px solid #dddddd; margin: 5px;
			 padding: 15px;">
				<h4 class="title is-4">Postgraduate Programmes</h4>
				<p>MTU offers a wide range of postgraduate programmes catering for a variety of interests, namely:
				Doctoral degree programmes take minimum three years after relevant Master’s degrees. In the first year, the students have to attend the coursework, at which the essential subjects for each programme are to be studied. And they will have another two years for their theses.
				Master’s degree programmes are primarily designed to do coursework and thesis. The programmes take minimum two years. The first year is for coursework and the second year is for thesis. For those, who want to continue the study (to attend Ph. D.) must be excellent in both coursework and thesis.
				Master programme provides students with advanced knowledge in key core areas of an advanced study of specialized topics. The program is designed to accommodate students with training in diverse scientific and engineering disciplines.</p>
				<h5 class="title is-5">Intake Schedule</h5>
				<p>MTU has two intakes per year, program for new Ph.D candidates in December and that for new M.E candidates in July.
	 			All Ph.D. applicants are welcome to contact the academic departments to discuss their 			  potential application. Research applicants are particularly encouraged to speak with 			 	departments regarding areas of interest and potential supervisors. (they don’t need to 			   take any class for course work, they have just entered to the thesis period) 
				The purpose of master programme is to provide advanced training in each respective field to prepare students for positions in industry and government and for further graduate study.</p>
				<h5 class="title is-5">Course Structure</h5>
				<p>Coursework and Dissertation mode (--credits) </p>
				<h5 class="title is-5">List of Master Degree Program</h5>
				<ul>
				...
				<h4 class="title is-4">Doctral Degree Programmes Offered</h4>
				<ul>
